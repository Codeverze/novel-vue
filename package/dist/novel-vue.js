...
class cn extends Qe {
  ...
  */
  ...
  map(e) {
    ...
    return t.deleted && r.deleted || t.pos >= r.pos ? null : new cn(t.pos, r.pos, this.mark);
  }
  merge(e) {
      ...
      if (r.length == t.marks.length) {
        for (let o = 0; o < t.marks.length; o++)
          if (!t.marks[o].isInSet(r))
            return new un(this.pos, t.marks[o]);
...
class Dr extends Qe {
  ...
  */
  ...
  invert(e) {
    let t = e.nodeAt(this.pos);
    return !t || !this.mark.isInSet(t.marks) ? this : new un(this.pos, this.mark);
  }
  map(e) {
    let t = e.mapResult(this.pos, 1);
...
function bg(n, e, t, r) {
  ...
  n.doc.nodesBetween(e, t, (l, c, u) => {
    ...
    if (!r.isInSet(d) && u.type.allowsMarkType(r.type)) {
      ...
      a && a.to == p ? a.to = f : s.push(a = new cn(p, f, r));
    }
...
const Lt = typeof navigator < "u" ? navigator : null, eu = typeof document < "u" ? document : null, vn = Lt && Lt.userAgent || "", za = /Edge\/(\d+)/.exec(vn), op = /MSIE \d/.exec(vn), $a = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(vn), Je = !!(op || $a || za), fn = op ? document.documentMode : $a ? +$a[1] : za ? +za[1] : 0, bt = !Je && /gecko\/(\d+)/i.test(vn);
bt && +(/Firefox\/(\d+)/.exec(vn) || [0, 0])[1];
const Ha = !Je && /Chrome\/(\d+)/.exec(vn), Ie = !!Ha, Kg = Ha ? +Ha[1] : 0, $e = !Je && !!Lt && /Apple Computer/.test(Lt.vendor), Nr = $e && (/Mobile\/\w+/.test(vn) || !!Lt && Lt.maxTouchPoints > 2), st = Nr || (Lt ? /Mac/.test(Lt.platform) : !1), Gg = Lt ? /Win/.test(Lt.platform) : !1, ht = /Android \d/.test(vn), pi = !!eu && "webkitFontSmoothing" in eu.documentElement.style, Jg = pi ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Zg(n) {
  return {
    left: 0,
...
function tu(n, e, t) {
  ...
  for (let i = t || n.dom; i; i = bo(i)) {
    ...
    if (e.top < c.top + qt(r, "top") ? d = -(c.top - e.top + qt(o, "top")) : e.bottom > c.bottom - qt(r, "bottom") && (d = e.bottom - e.top > c.bottom - c.top ? e.top + qt(o, "top") - c.top : e.bottom - c.bottom + qt(o, "bottom")), e.left < c.left + qt(r, "left") ? u = -(c.left - e.left + qt(o, "left")) : e.right > c.right - qt(r, "right") && (u = e.right - c.right + qt(o, "right")), u || d)
      if (l)
...
function cp(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (i && (i0.test(r.nodeValue) || (t < 0 ? !o : o == r.nodeValue.length))) {
      ...
      if (bt && o && /\s/.test(r.nodeValue[o - 1]) && o < r.nodeValue.length) {
        let c = tn($t(r, o - 1, o - 1), -1);
        if (c.top == l.top) {
          let u = tn($t(r, o, o + 1), -1);
          if (u.top != l.top)
      ...
      return t < 0 && !o ? (c++, u = -1) : t >= 0 && o == r.nodeValue.length ? (l--, u = 1) : t < 0 ? l-- : c++, Yr(tn($t(r, l, c), u), u < 0);
    }
  ...
  if (s == null && o && (t < 0 || o == At(r))) {
    let l = r.childNodes[o - 1], c = l.nodeType == 3 ? $t(l, At(l) - (i ? 0 : 1)) : l.nodeType == 1 && (l.nodeName != "BR" || !l.nextSibling) ? l : null;
    if (c)
      return Yr(tn(c, 1), !1);
  }
  if (s == null && o < At(r)) {
    ...
    for (; l.pmViewDesc && l.pmViewDesc.ignoreForCoords; )
      l = l.nextSibling;
    let c = l ? l.nodeType == 3 ? $t(l, 0, i ? 0 : 1) : l.nodeType == 1 ? l : null : null;
    if (c)
      return Yr(tn(c, -1), !0);
  }
  return Yr(tn(r.nodeType == 3 ? $t(r) : r, -t), t >= 0);
}
function Yr(n, e) {
  if (n.width == 0)
    return n;
  ...
  return up(n, e, () => {
    ...
    for (let a = s.firstChild; a; a = a.nextSibling) {
      ...
      if (a.nodeType == 1)
        ...
        l = $t(a, 0, a.nodeValue.length).getClientRects();
      else
        continue;
  ...
  markDirty(e, t) {
    for (let r = 0, o = 0; o < this.children.length; o++) {
      ...
      if (r == i ? e <= i && t >= r : e < i && t > r) {
        ...
        if (e >= a && t <= l) {
          this.dirty = e == r || t == i ? _n : iu, e == a && t == l && (s.contentLost || s.dom.parentNode != this.contentDOM) ? s.dirty = It : s.markDirty(e - a, t - a);
          return;
        } else
          s.dirty = s.dom == s.contentDOM && s.dom.parentNode == this.contentDOM && !s.children.length ? _n : It;
      }
      r = i;
    }
    this.dirty = _n;
...
class pn extends Lo {
  ...
  static create(e, t, r, o, s, i) {
    ...
    let p = u;
    return u = mp(u, r, t), c ? l = new f0(e, t, r, o, u, d || null, p, c, s, i + 1) : t.isText ? new hi(e, t, r, o, u, p, s) : new pn(e, t, r, o, u, d || null, p, s, i + 1);
  }
  parseRule() {
  ...
  update(e, t, r, o) {
    return this.dirty == It || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, t, r, o), !0);
  }
  updateInner(e, t, r, o) {
...
function au(n, e, t, r, o) {
  mp(r, e, n);
  let s = new pn(void 0, n, e, t, r, r, r, o, 0);
...
class hi extends pn {
  ...
  update(e, t, r, o) {
    return this.dirty == It || this.dirty != at && !this.inParent() || !e.sameMarkup(this.node) ? !1 : (this.updateOuterDeco(t), (this.dirty != at || e.text != this.node.text) && e.text != this.nodeDOM.nodeValue && (this.nodeDOM.nodeValue = e.text, o.trackWrites == this.nodeDOM && (o.trackWrites = null)), this.node = e, this.dirty = at, !0);
  }
  inParent() {
...
class h0 {
  ...
  updateNodeAt(e, t, r, o, s) {
    ...
    return i.dirty == It && i.dom == i.contentDOM && (i.dirty = _n), i.update(e, t, r, s) ? (this.destroyBetween(this.index, o), this.index++, !0) : !1;
  }
  ...
  updateNextNode(e, t, r, o, s, i) {
    for (let a = this.index; a < this.top.children.length; a++) {
      ...
      if (l instanceof pn) {
        ...
        if (c != null && c != s)
          return !1;
        let u = l.dom, d, p = this.isLocked(u) && !(e.isText && l.node && l.node.isText && l.nodeDOM.nodeValue == e.text && l.dirty != It && ja(t, l.outerDeco));
  ...
  recreateWrapper(e, t, r, o, s, i) {
    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content))
      return null;
    let a = pn.create(this.top, t, r, o, s, i);
    if (!a.contentDOM)
      return null;
  ...
  addNode(e, t, r, o, s) {
    let i = pn.create(this.top, e, t, r, o, s);
...
function w0(n) {
  ...
  o ? t.setEnd(r.parentNode, Be(r) + 1) : t.setEnd(r, 0), t.collapse(!1), e.removeAllRanges(), e.addRange(t), !o && !n.state.selection.visible && Je && fn <= 11 && (r.disabled = !0, r.disabled = !1);
}
function yp(n, e) {
  if (e instanceof H) {
...
Ve.keydown = (n, e) => {
  ...
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Op(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(ht && Ie && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Nr && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || O0(n, t) ? t.preventDefault() : dn(n, "key");
};
Ve.keyup = (n, e) => {
...
He.mousedown = (n, e) => {
  ...
  i && (s == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new G0(n, i, t, !!r)) : (s == "doubleClick" ? U0 : W0)(n, i.pos, i.inside, t) ? t.preventDefault() : dn(n, "pointer"));
};
class G0 {
  constructor(e, t, r, o) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(mi(e))), this.updateAllowDefault(e), this.allowDefault || !t ? dn(this.view, "pointer") : j0(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    Ie && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (Tr(this.view, Z.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : dn(this.view, "pointer");
  }
  move(e) {
...
He.touchstart = (n) => {
  n.input.lastTouch = Date.now(), zl(n), dn(n, "pointer");
};
He.touchmove = (n) => {
...
class hn {
  ...
  eq(e) {
    return this == e || e instanceof hn && xo(this.attrs, e.attrs) && xo(this.spec, e.spec);
  }
  static is(e) {
...
class pe {
  ...
  */
  forChild(e, t) {
    ...
    for (let a = 0; a < this.local.length; a++) {
      let l = this.local[a];
      if (l.from < i && l.to > s && l.type instanceof hn) {
...
class an {
  ...
  forChild(e, t) {
    ...
    for (let o = 0; o < this.members.length; o++) {
      ...
      s != Le && (s instanceof an ? r = r.concat(s.members) : r.push(s));
    }
    return an.from(r);
  }
  eq(e) {
    if (!(e instanceof an) || e.members.length != this.members.length)
      return !1;
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new an(e.every((t) => t instanceof pe) ? e : e.reduce((t, r) => t.concat(r instanceof pe ? r : r.members), []));
    }
  }
}
...
function Ji(n) {
  ...
  return n.someProp("decorations", (t) => {
    let r = t(n.state);
    r && r != Le && e.push(r);
  }), n.cursorWrapper && e.push(pe.create(n.state.doc, [n.cursorWrapper.deco])), an.from(e);
}
const ry = {
  childList: !0,
  characterData: !0,
...
class iy {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new sy(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let o = 0; o < r.length; o++)
        this.queue.push(r[o]);
      Je && fn <= 11 && r.some((o) => o.type == "childList" && o.removedNodes.length || o.type == "characterData" && o.oldValue.length > o.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange() {
    if (pu(this.view)) {
      if (this.suppressingSelectionUpdates)
        return Kt(this.view);
      if (Je && fn <= 11 && !this.view.state.selection.empty) {
  ...
  flush() {
    ...
    let c = null;
    s < 0 && o && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && fi(r) && (c = Pl(e)) && c.eq(Z.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Kt(e), this.currentSelection.set(r), e.scrollToSelection()) : (s > -1 || o) && (s > -1 && (e.docView.markDirty(s, i), ay(e)), this.handleDOMChange(s, i, a, l), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Kt(e), this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      if (Je && fn <= 11 && e.addedNodes.length)
        for (let u = 0; u < e.addedNodes.length; u++) {
...
function fy(n, e, t, r, o) {
  ...
  n.input.domChangeCount++, n.state.selection.from < n.state.selection.to && h.start == h.endB && n.state.selection instanceof K && (h.start > n.state.selection.from && h.start <= n.state.selection.from + 2 && n.state.selection.from >= c.from ? h.start = n.state.selection.from : h.endA < n.state.selection.to && h.endA >= n.state.selection.to - 2 && n.state.selection.to <= c.to && (h.endB += n.state.selection.to - h.endA, h.endA = n.state.selection.to)), Je && fn <= 11 && h.endB == h.start + 1 && h.endA == h.start && h.start > c.from && c.doc.textBetween(h.start - c.from - 1, h.start - c.from + 1) == "  " && (h.start--, h.endA--, h.endB--);
  ...
  if (b) {
    if (m.pos == g.pos)
      Je && fn <= 11 && m.parentOffset == 0 && (n.domObserver.suppressSelectionUpdates(), setTimeout(() => Kt(n), 20)), k = n.state.tr.delete(y, w), S = u.resolve(h.start).marksAcross(u.resolve(h.endA));
    else if (
...
class gy {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (s) {
      ...
      p || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && S0(this)) ? Kt(this, p) : (yp(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && e0(this.dom), Kt(this), this.domObserver.start();
  }
  /**
...
for (var _e = 0; _e < 10; _e++)
  gn[48 + _e] = gn[96 + _e] = String(_e);
for (var _e = 1; _e <= 24; _e++)
  gn[_e + 111] = "F" + _e;
for (var _e = 65; _e <= 90; _e++)
  gn[_e] = String.fromCharCode(_e + 32), _s[_e] = String.fromCharCode(_e);
for (var Yi in gn)
  _s.hasOwnProperty(Yi) || (_s[Yi] = gn[Yi]);
function xy(n) {
  var e = by && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || ky && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? _s : gn)[n.keyCode] || n.key || "Unidentified";
...
function Pp(n) {
  ...
  return function(t, r) {
    ...
    if (o.length == 1 && o != " ") {
      ...
      if ((r.shiftKey || r.altKey || r.metaKey || o.charCodeAt(0) > 127) && (s = gn[r.keyCode]) && s != o) {
        let a = e[Qi(s, r)];
        if (a && a(t.state, t.dispatch, t))
          return !0;
      }
...
function Wp(n, e = null) {
  ...
  return e === "all" ? K.create(n, jt(0, o, s), jt(n.content.size, o, s)) : K.create(n, jt(e, o, s), jt(e, o, s));
}
function Kl() {
  return [
    "iPad Simulator",
...
function Jp(n, e, t) {
  const o = n.state.doc.content.size, s = jt(e, 0, o), i = jt(t, 0, o), a = n.coordsAtPos(s), l = n.coordsAtPos(i, -1), c = Math.min(a.top, l.top), u = Math.max(a.bottom, l.bottom), d = Math.min(a.left, l.left), p = Math.max(a.right, l.right), f = p - d, h = u - c, v = {
    top: c,
    bottom: u,
    left: d,
    right: p,
...
const pb = (n, e = {}) => ({ tr: t, state: r, dispatch: o }) => {
  ...
  if (t) {
    const { doc: r } = e, o = jt(n, 0, r.content.size), s = H.create(r, o);
    e.setSelection(s);
  }
  return !0;
}, yb = (n) => ({ tr: e, dispatch: t }) => {
  if (t) {
    const { doc: r } = e, { from: o, to: s } = typeof n == "number" ? { from: n, to: n } : n, i = K.atStart(r).from, a = K.atEnd(r).to, l = jt(o, i, a), c = jt(s, i, a), u = K.create(r, l, c);
    e.setSelection(u);
  }
  return !0;
...
function Xb(n) {
  ...
  Object.keys(e.elements).forEach(function(t) {
    ...
    !lt(s) || !Rt(s) || (Object.assign(s.style, r), Object.keys(o).forEach(function(i) {
      var a = o[i];
...
function ek(n) {
  ...
  return Object.assign(e.elements.popper.style, t.popper), e.styles = t, e.elements.arrow && Object.assign(e.elements.arrow.style, t.arrow), function() {
    Object.keys(e.elements).forEach(function(r) {
      ...
      !lt(o) || !Rt(o) || (Object.assign(o.style, a), Object.keys(s).forEach(function(l) {
        o.removeAttribute(l);
      }));
    });
  };
...
function qu(n) {
  ...
  Jt(n).position === "fixed" ? null : n.offsetParent;
}
function nk(n) {
  ...
  var o = xi(n);
  for (Xl(o) && (o = o.host); lt(o) && ["html", "body"].indexOf(Rt(o)) < 0; ) {
    var s = Jt(o);
...
function Bo(n) {
  for (var e = tt(n), t = qu(n); t && tk(t) && Jt(t).position === "static"; )
    t = qu(t);
  return t && (Rt(t) === "html" || Rt(t) === "body" && Jt(t).position === "static") ? e : t || nk(n) || e;
}
function tc(n) {
...
function zu(n) {
  ...
  if (c) {
    ...
    if (k === tt(t) && (k = kn(t), Jt(k).position !== "static" && a === "absolute" && (S = "scrollHeight", C = "scrollWidth")), k = k, o === Ze || (o === Ye || o === ut) && s === So) {
      y = ct;
...
function yk(n) {
  ...
  return Jt(o || t).direction === "rtl" && (a += Hn(t.clientWidth, o ? o.clientWidth : 0) - s), {
    width: s,
    height: i,
    x: a,
    y: l
...
function oc(n) {
  var e = Jt(n), t = e.overflow, r = e.overflowX, o = e.overflowY;
  return /auto|scroll|overlay|hidden/.test(t + o + r);
}
function ih(n) {
  return ["html", "body", "#document"].indexOf(Rt(n)) >= 0 ? n.ownerDocument.body : lt(n) && oc(n) ? n : ih(xi(n));
}
function co(n, e) {
  var t;
  e === void 0 && (e = []);
...
function bk(n) {
  var e = co(xi(n)), t = ["absolute", "fixed"].indexOf(Jt(n).position) >= 0, r = t && lt(n) ? Bo(n) : n;
  return Xn(r) ? e.filter(function(o) {
    return Xn(o) && nh(o, r) && Rt(o) !== "body";
  }) : [];
}
function kk(n, e, t, r) {
  ...
  if (k) {
    if (s) {
      var R, A = y === "y" ? Ze : Ye, B = y === "y" ? ct : ut, L = y === "y" ? "height" : "width", z = k[y], Q = z + g[A], ee = z - g[B], ye = f ? -C[L] / 2 : 0, xe = b === Pr ? S[L] : C[L], Me = b === Pr ? -C[L] : -S[L], G = e.elements.arrow, Y = f && G ? ec(G) : {
        width: 0,
        height: 0
      }, se = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : rh(), we = se[A], je = se[B], Ue = lo(0, S[L], Y[L]), or = x ? S[L] / 2 - ye - Ue - we - O.mainAxis : xe - Ue - we - O.mainAxis, Qt = x ? -S[L] / 2 + ye + Ue + je + O.mainAxis : Me + Ue + je + O.mainAxis, sr = e.elements.arrow && Bo(e.elements.arrow), $o = sr ? y === "y" ? sr.clientTop || 0 : sr.clientLeft || 0 : 0, Wr = (R = _ == null ? void 0 : _[y]) != null ? R : 0, Ho = z + or - Wr - $o, Vo = z + Qt - Wr, Kr = lo(f ? Is(Q, Ho) : Q, z, f ? Hn(ee, Vo) : ee);
      k[y] = Kr, q[y] = Kr - z;
    }
    if (a) {
      var Gr, jo = y === "x" ? Ze : Ye, Uo = y === "x" ? ct : ut, Ft = k[w], Xt = w === "y" ? "height" : "width", Jr = Ft + g[jo], wn = Ft - g[Uo], Zr = [Ze, Ye].indexOf(v) !== -1, Wo = (Gr = _ == null ? void 0 : _[w]) != null ? Gr : 0, Ko = Zr ? Jr : Ft - S[Xt] - C[Xt] - Wo + O.altAxis, Go = Zr ? Ft + S[Xt] + C[Xt] - Wo - O.altAxis : wn, Jo = f && Zr ? rk(Ko, Ft, Go) : lo(f ? Ko : Jr, Ft, f ? Go : wn);
      k[w] = Jo, q[w] = Jo - Ft;
    }
    e.modifiersData[r] = q;
  }
...
function yh(n, e) {
  ...
  t.forEach(function(r) {
    ...
    s && (s = e.filter(function(i) {
      return i.name === r;
    }).length === 0), Ht(s, ["`" + r + "`", "is not a valid prop. You may have spelled it incorrectly, or if it's", "a plugin, forgot to pass it in an array as props.plugins.", `
...
function b1(n, e) {
  ...
  function Ho(E) {
    ...
    if (!(E.type === "mousemove" && j)) {
      var ae = Xt().concat(k).map(function(X) {
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function Go(E) {
    if (process.env.NODE_ENV !== "production" && Ht(y.state.isDestroyed, cr("setProps")), !y.state.isDestroyed) {
      ...
      }) : j.triggerTarget && n.removeAttribute("aria-expanded"), ye(), z(), S && S(P, j), y.popperInstance && (jo(), Xt().forEach(function(ae) {
  ...
  function Pm() {
    process.env.NODE_ENV !== "production" && Ht(y.state.isDestroyed, cr("show"));
  ...
  function Bm() {
    process.env.NODE_ENV !== "production" && Ht(y.state.isDestroyed, cr("hide"));
  ...
  function Fm(E) {
    process.env.NODE_ENV !== "production" && Ht(y.state.isDestroyed, cr("hideWithInteractivity")), A().addEventListener("mousemove", h), Gu(ns, h), h(E);
  }
  function qm() {
    process.env.NODE_ENV !== "production" && Ht(y.state.isDestroyed, cr("unmount")), y.state.isVisible && y.hide(), y.state.isMounted && (Uo(), Xt().forEach(function(E) {
      E._tippy.unmount();
  ...
  function zm() {
    process.env.NODE_ENV !== "production" && Ht(y.state.isDestroyed, cr("destroy")), !y.state.isDestroyed && (y.clearDelayTimeouts(), y.unmount(), $o(), delete n._tippy, y.state.isDestroyed = !0, Q("onDestroy", [y]));
  }
}
function rr(n, e) {
  e === void 0 && (e = {});
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    Ht(s && i, ["tippy() was passed an Element as the `content` prop, but more than", "one tippy instance was created by this invocation. This means the", "content element will only be appended to the last tippy instance.", `
...
function ld() {
  for (var n = this, e = [], t = 0; t < arguments.length; t++)
    e[t] = arguments[t];
  var r, o, s = Vt({}, Ch), i = !1, a = !1, l = Cf(), c = (l == null ? void 0 : l.proxy) || l;
  if (!c)
    return console.error("Could not get current instance, check to make sure that `useSwrv` is declared in the top level of the setup function."), null;
  var u = (c == null ? void 0 : c.$isServer) || !1;
  e.length >= 1 && (r = e[0]), e.length >= 2 && (o = e[1]), e.length > 2 && (s = Vt(Vt({}, s), e[2]));
  ...
  var v = Vt(Vt({}, Km(f)), { mutate: function(b, x) {
    return h(b, Vt(Vt({}, x), { forceRevalidate: !0 }));
  } });
  return v;
}
function Y1(n) {
...
const Ix = 20;
function Rx(n, e, t, r) {
  let o = t.getMeta(mn), s;
  if (o)
    return o.historyState;
  t.getMeta(Bx) && (n = new nn(n.done, n.undone, null, 0, -1));
  let i = t.getMeta("appendedTransaction");
  if (t.steps.length == 0)
    return n;
  if (i && i.getMeta(mn))
    return i.getMeta(mn).redo ? new nn(n.done.addTransform(t, void 0, r, vs(e)), n.undone, hd(t.mapping.maps[t.steps.length - 1]), n.prevTime, n.prevComposition) : new nn(n.done, n.undone.addTransform(t, void 0, r, vs(e)), null, n.prevTime, n.prevComposition);
  if (t.getMeta("addToHistory") !== !1 && !(i && i.getMeta("addToHistory") === !1)) {
    ...
    return new nn(n.done.addTransform(t, l ? e.selection.getBookmark() : void 0, r, vs(e)), gt.empty, c, t.time, a ?? n.prevComposition);
  } else
    return (s = t.getMeta("rebased")) ? new nn(n.done.rebased(t, s), n.undone.rebased(t, s), da(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new nn(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), da(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function Px(n, e) {
  if (!e)
    return !1;
...
function Th(n, e, t, r) {
  let o = vs(e), s = mn.get(e).spec.config, i = (r ? n.undone : n.done).popEvent(e, o);
  if (!i)
    return;
  let a = i.selection.resolve(i.transform.doc), l = (r ? n.done : n.undone).addTransform(i.transform, e.selection.getBookmark(), s, o), c = new nn(r ? l : i.remaining, r ? i.remaining : l, null, 0, -1);
  t(i.transform.setSelection(a).setMeta(mn, { redo: r, historyState: c }).scrollIntoView());
}
let fa = !1, md = null;
function vs(n) {
  let e = n.plugins;
...
const mn = new Ne("history"), Bx = new Ne("closeHistory");
function Fx(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    state: {
      init() {
        return new nn(gt.empty, gt.empty, null, 0, -1);
      },
      apply(e, t, r) {
        return Rx(t, r, e, n);
      }
...
const F = (n, e, t, r, o) => n.ta(e, t, r, o), ot = (n, e, t, r, o) => n.tr(e, t, r, o), bd = (n, e, t, r, o) => n.ts(e, t, r, o), D = (n, e, t, r, o) => n.tt(e, t, r, o), zt = "WORD", pl = "UWORD", Mo = "LOCALHOST", hl = "TLD", ml = "UTLD", ks = "SCHEME", yr = "SLASH_SCHEME", lc = "NUM", Nh = "WS", cc = "NL", kr = "OPENBRACE", fo = "OPENBRACKET", po = "OPENANGLEBRACKET", ho = "OPENPAREN", On = "CLOSEBRACE", xr = "CLOSEBRACKET", wr = "CLOSEANGLEBRACKET", Dn = "CLOSEPAREN", Fs = "AMPERSAND", qs = "APOSTROPHE", zs = "ASTERISK", rn = "AT", $s = "BACKSLASH", Hs = "BACKTICK", Vs = "CARET", ln = "COLON", uc = "COMMA", js = "DOLLAR", wt = "DOT", Us = "EQUALS", dc = "EXCLAMATION", St = "HYPHEN", Ws = "PERCENT", Ks = "PIPE", Gs = "PLUS", Js = "POUND", Zs = "QUERY", fc = "QUOTE", pc = "SEMI", Ct = "SLASH", mo = "TILDE", Ys = "UNDERSCORE", Lh = "EMOJI", Qs = "SYM";
...
function lw(n) {
  ...
  Ke.groups = e;
  const t = new Ke();
  ls == null && (ls = wd(ew)), cs == null && (cs = wd(tw)), D(t, "'", qs), D(t, "{", kr), D(t, "[", fo), D(t, "<", po), D(t, "(", ho), D(t, "}", On), D(t, "]", xr), D(t, ">", wr), D(t, ")", Dn), D(t, "&", Fs), D(t, "*", zs), D(t, "@", rn), D(t, "`", Hs), D(t, "^", Vs), D(t, ":", ln), D(t, ",", uc), D(t, "$", js), D(t, ".", wt), D(t, "=", Us), D(t, "!", dc), D(t, "-", St), D(t, "%", Ws), D(t, "|", Ks), D(t, "+", Gs), D(t, "#", Js), D(t, "?", Zs), D(t, '"', fc), D(t, "/", Ct), D(t, ";", pc), D(t, "~", mo), D(t, "_", Ys), D(t, "\\", $s);
  const r = ot(t, ma, lc, {
    [cl]: !0
  });
  ot(r, ma, r);
  ...
  Ln(hl, {
    ...
    utld: !0,
    alpha: !0
  }, e), en(t, "file", ks, zt, c), en(t, "mailto", ks, zt, c), en(t, "http", yr, zt, c), en(t, "https", yr, zt, c), en(t, "ftp", yr, zt, c), en(t, "ftps", yr, zt, c), Ln(ks, {
    scheme: !0,
    ascii: !0
  }, e), Ln(yr, {
    slashscheme: !0,
...
const Cd = wi("email", {
  ...
  */
  ...
  hasProtocol() {
    const n = this.tk;
    return n.length >= 2 && n[0].t !== Mo && n[1].t === ln;
  }
}), Se = (n) => new Ke(n);
function fw(n) {
  let {
  ...
  const t = e.domain.concat([Fs, zs, rn, $s, Hs, Vs, js, Us, St, lc, Ws, Ks, Gs, Js, Ct, Qs, mo, Ys]), r = [qs, wr, On, xr, Dn, ln, uc, wt, dc, po, kr, fo, ho, Zs, fc, pc], o = [Fs, qs, zs, $s, Hs, Vs, On, js, Us, St, kr, Ws, Ks, Gs, Js, Zs, Ct, Qs, mo, Ys], s = Se(), i = D(s, mo);
  F(i, o, i), F(i, e.domain, i);
  const a = Se(), l = Se(), c = Se();
  F(s, e.domain, a), F(s, e.scheme, l), F(s, e.slashscheme, c), F(a, o, i), F(a, e.domain, a);
  const u = D(a, rn);
  D(i, rn, u), D(l, rn, u), D(c, rn, u);
  const d = D(i, wt);
  ...
  const x = Se(Cn);
  F(b, e.tld, x), F(b, e.utld, x), F(x, e.domain, a), F(x, o, i), D(x, wt, b), D(x, St, v), D(x, rn, u);
  const y = D(x, ln), w = Se(Cn);
  F(y, e.numeric, w);
  const k = Se(Cn), S = Se();
  F(k, t, k), F(k, r, S), F(S, t, k), F(S, r, S), D(x, Ct, k), D(w, Ct, k);
  const C = D(l, ln), T = D(c, ln), O = D(T, Ct), _ = D(O, Ct);
...
var yee = oe.assign, vee = oe.unescapeAll, er = oe.escapeHtml, Pt = {};
Pt.code_inline = function(n, e, t, r, o) {
  var s = n[e];
  return "<code" + o.renderAttrs(s) + ">" + er(n[e].content) + "</code>";
};
Pt.code_block = function(n, e, t, r, o) {
  var s = n[e];
  return "<pre" + o.renderAttrs(s) + "><code>" + er(n[e].content) + `</code></pre>
`;
};
Pt.fence = function(n, e, t, r, o) {
...
Pt.image = function(n, e, t, r, o) {
  var s = n[e];
  return s.attrs[s.attrIndex("alt")][1] = o.renderInlineAsText(s.children, t, r), o.renderToken(n, e, t);
};
Pt.hardbreak = function(n, e, t) {
  return t.xhtmlOut ? `<br />
` : `<br>
`;
};
Pt.softbreak = function(n, e, t) {
  return t.breaks ? t.xhtmlOut ? `<br />
` : `<br>
` : `
`;
};
Pt.text = function(n, e) {
  return er(n[e].content);
};
Pt.html_block = function(n, e) {
  return n[e].content;
};
Pt.html_inline = function(n, e) {
  return n[e].content;
};
function jr() {
  this.rules = yee({}, Pt);
...
Bt.prototype.skipCharsBack = function(e, t, r) {
  if (e <= r)
    return e;
  for (; e > r; )
...
Bt.prototype.getLines = function(e, t, r, o) {
...
Bt.prototype.Token = Kh;
var bte = Bt, kte = gc, fs = [
...
const Xh = (n) => String.fromCodePoint(...n), vne = function(n) {
  ...
  i < 0 && (i = 0);
  for (let a = 0; a < i; ++a)
    n.charCodeAt(a) >= 128 && on("not-basic"), e.push(n.charCodeAt(a));
  for (let a = i > 0 ? i + 1 : 0; a < t; ) {
    const l = r;
    for (let u = 1, d = Ot; ; d += Ot) {
      a >= t && on("invalid-input");
      const p = vne(n.charCodeAt(a++));
      p >= Ot && on("invalid-input"), p > Dt((Mr - r) / u) && on("overflow"), r += p * u;
      const f = d <= s ? xc : d >= s + Do ? Do : d - s;
      if (p < f)
        break;
      const h = Ot - f;
      u > Dt(Mr / h) && on("overflow"), u *= h;
    }
    const c = e.length + 1;
    s = em(r - l, c, l == 0), Dt(r / c) > Mr - o && on("overflow"), o += Dt(r / c), r %= c, e.splice(r++, 0, o);
  }
  ...
  for (i && e.push(Yh); a < t; ) {
    ...
    for (const u of n)
      u >= r && u < l && (l = u);
    const c = a + 1;
    l - r > Dt((Mr - o) / c) && on("overflow"), o += (l - r) * c, r = l;
    for (const u of n)
      if (u < r && ++o > Mr && on("overflow"), u === r) {
        let d = o;
        for (let p = Ot; ; p += Ot) {
...
`
  ...
  setup(n, { expose: e }) {
    const t = n, r = $(0), { complete: o, isLoading: s } = Eh({
      id: "novel-vue",
      api: Nt("completionApi"),
      headers: Nt("apiHeaders"),
      onResponse: (p) => {
...
function Yt({ visible: n = !0, features: e = 0, ourProps: t, theirProps: r, ...o }) {
  var s;
...
var sn = ((n) => (n.Space = " ", n.Enter = "Enter", n.Escape = "Escape", n.Backspace = "Backspace", n.Delete = "Delete", n.ArrowLeft = "ArrowLeft", n.ArrowUp = "ArrowUp", n.ArrowRight = "ArrowRight", n.ArrowDown = "ArrowDown", n.Home = "Home", n.End = "End", n.PageUp = "PageUp", n.PageDown = "PageDown", n.Tab = "Tab", n))(sn || {});
function U(n) {
  var e;
...
var Ut = ((n) => (n[n.First = 1] = "First", n[n.Previous = 2] = "Previous", n[n.Next = 4] = "Next", n[n.Last = 8] = "Last", n[n.WrapAround = 16] = "WrapAround", n[n.NoScroll = 32] = "NoScroll", n))(Ut || {}), si = ((n) => (n[n.Error = 0] = "Error", n[n.Overflow = 1] = "Overflow", n[n.Success = 2] = "Success", n[n.Underflow = 3] = "Underflow", n))(si || {}), aie = ((n) => (n[n.Previous = -1] = "Previous", n[n.Next = 1] = "Next", n))(aie || {});
...
function Em(n, e = 0) {
  var t;
  return n === ((t = xn(n)) == null ? void 0 : t.body) ? !1 : Zt(e, { 0() {
    return n.matches(Al);
  }, 1() {
    let r = n;
    for (; r !== null; ) {
...
let No = ue({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(n, { slots: e, attrs: t }) {
  return () => {
    ...
    return Yt({ ourProps: s, theirProps: o, slot: {}, attrs: t, slots: e, name: "Hidden" });
  };
} });
var Wt = ((n) => (n[n.Forwards = 0] = "Forwards", n[n.Backwards = 1] = "Backwards", n))(Wt || {});
function Tm() {
  let n = $(0);
  return Am("keydown", (e) => {
...
ue({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: !1 } }, setup(n, { slots: e, attrs: t }) {
  return Gt(Mm, n.force), () => {
    let { force: r, ...o } = n;
    return Yt({ theirProps: o, ourProps: {}, slot: {}, slots: e, attrs: t, name: "ForcePortalRoot" });
  };
} });
function mie(n) {
  let e = xn(n);
...
ue({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(n, { slots: e, attrs: t }) {
  let r = $(null), o = ie(() => xn(r)), s = hie(), i = Nt(Om, null), a = $(s === !0 || i == null ? mie(r.value) : i.resolveTarget());
  qe(() => {
  ...
  return vt(() => {
    ...
    return fe(Ef, { to: a.value }, Yt({ ourProps: c, theirProps: n, slot: {}, attrs: t, slots: e, name: "Portal" }));
  };
} });
...
ue({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(n, { attrs: e, slots: t }) {
  ...
  return Gt(Om, r), () => {
    let { target: o, ...s } = n;
    return Yt({ theirProps: s, ourProps: {}, slot: {}, attrs: e, slots: t, name: "PortalGroup" });
  };
} });
...
let Lc = ue({ name: "Popover", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" } }, setup(n, { slots: e, attrs: t, expose: r }) {
  ...
  Gt(Dm, f), nie(ie(() => Zt(i.value, { 0: nr.Open, 1: nr.Closed })));
  ...
  return qe(() => g == null ? void 0 : g(h)), pie((o = d.value) == null ? void 0 : o.defaultView, "focus", (w) => {
    ...
    return fe(ze, [fe(b, {}, () => Yt({ theirProps: { ...n, ...t }, ourProps: { ref: s }, slot: w, slots: e, attrs: t, name: "Popover" })), fe(x.MainTreeNode)]);
  };
  ...
  function h(x) {
    c.value || x.key === sn.Space && x.preventDefault();
  }
  function m(x) {
    var y, w;
  ...
  function b() {
    ...
    if (!x)
      return;
    function y() {
      Zt(v.value, { [Wt.Forwards]: () => Rn(x, Ut.First), [Wt.Backwards]: () => Rn(x, Ut.Last) }) === si.Error && Rn(Li().filter((w) => w.dataset.headlessuiFocusGuard !== "true"), Zt(v.value, { [Wt.Forwards]: Ut.Next, [Wt.Backwards]: Ut.Previous }), { relativeTo: U(o.button) });
    }
    y();
  }
  return () => {
    ...
    return fe(ze, [Yt({ ourProps: S, theirProps: { ...e, ...k }, slot: y, attrs: e, slots: t, name: "PopoverButton" }), x && !c.value && o.isPortalled.value && fe(No, { id: d, features: $r.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: b })]);
  };
} });
ue({ name: "PopoverOverlay", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 } }, setup(n, { attrs: e, slots: t }) {
  ...
  return () => {
    ...
    return Yt({ ourProps: { id: o, "aria-hidden": !0, onClick: a }, theirProps: n, slot: l, attrs: e, slots: t, features: _o.RenderStrategy | _o.Static, visible: i.value, name: "PopoverOverlay" });
  };
} });
let Rm = ue({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, focus: { type: Boolean, default: !1 }, id: { type: String, default: () => `headlessui-popover-panel-${Or()}` } }, inheritAttrs: !1, setup(n, { attrs: e, slots: t, expose: r }) {
  ...
  r({ el: s.panel, $el: s.panel }), vt(() => {
    ...
    (v = U(s.panel)) != null && v.contains(b) || Rn(U(s.panel), Ut.First);
  });
  ...
  function h() {
    ...
    if (!g)
      return;
    function v() {
      Zt(f.value, { [Wt.Forwards]: () => {
        var b;
        Rn(g, Ut.First) === si.Error && ((b = U(s.afterPanelSentinel)) == null || b.focus());
      }, [Wt.Backwards]: () => {
        var b;
  ...
  function m() {
    ...
    function v() {
      Zt(f.value, { [Wt.Forwards]: () => {
        ...
        Rn(S, Ut.First, { sorted: !1 });
      }, [Wt.Backwards]: () => {
        var b;
        Rn(g, Ut.Previous) === si.Error && ((b = U(s.button)) == null || b.focus());
      } });
    }
    v();
  }
  return () => {
    ...
    return Yt({ ourProps: y, theirProps: { ...e, ...x }, attrs: e, slot: g, slots: { ...t, default: (...w) => {
      var k;
...
ue({ name: "PopoverGroup", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" } }, setup(n, { attrs: e, slots: t, expose: r }) {
  ...
  return Gt(_m, { registerPopover: c, unregisterPopover: l, isFocusWithinPopoverGroup: u, closeOthers: d, mainTreeNodeRef: a.mainTreeNodeRef }), () => fe(ze, [Yt({ ourProps: { ref: o }, theirProps: { ...n, ...e }, slot: {}, attrs: e, slots: t, name: "PopoverGroup" }), fe(a.MainTreeNode)]);
} });
const xie = { class: "relative" }, wie = ["onClick"], Sie = { class: "flex items-center space-x-2" }, Cie = { class: "p-1 border rounded-sm border-stone-200" }, Eie = /* @__PURE__ */ ue({
  ...
  setup(n, { expose: e }) {
    const t = n;
    Gt("completionApi", t.completionApi), Gt("apiHeaders", t.apiHeaders), ll("blobApi", t.blobApi);
